...
#     parser.add_argument('--output_dir', default='.', help='rosbag image output dir')
#     parser.add_argument('--msg_type', default='color', type=str, help='choose to save color or depth')
